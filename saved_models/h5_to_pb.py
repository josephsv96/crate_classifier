# ref:https://www.dlology.com/blog/how-to-convert-trained-keras-model-to-tensorflow-and-make-prediction/
# use tf.__version__== 1.15
...
model = load_model('model_1_aug_pretrained.h5')
print(model.outputs)
print(model.inputs)
